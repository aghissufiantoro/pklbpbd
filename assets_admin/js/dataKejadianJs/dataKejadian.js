const BASE_URL = "http://localhost:80/bpbd";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function addNewDataKejadian() {
    ...
    const containerForConditionalButton =
      document.getElementById("conditional-btn");
  ...
  function renderConditionalButton(submitted) {
    ...
    containerForConditionalButton.innerHTML = submitted
      ? btnAddNewDataKejadian
      : submitButton;
    if (submitted) {
      console.log("submitted add event");
      document
        .getElementById("btnAddNewDataKejadian")
        .addEventListener("click", addNewDataKejadian);
    }
  }
  ...
  function clearForm() {
    ...
    var optionDropDownWilayah =
      document.getElementById("lokasi_kejadian").options;
  ...
  function contentChanged() {
    var selectedKecamatan = document.getElementById(
      "select2-kecamatan_kejadian-container"
    );
    console.log(selectedKecamatan.title);

    if (
      selectedKecamatan.title !== "--- Mohon Pilih Kecamatan ---" &&
      selectedKecamatan.title !== pastValue
    ) {
  ...
  document
    .getElementById("lokasi_kejadian")
    ...
    fetch(`${BASE_URL}/admin/data_kejadian/get_daerah`, {
      ...
      .then((data) => {
        ...
        var defaultOption = new Option(
          `--- Pilih ${capitalizeFirstLetter(dataType)} ---`,
          ""
        );
  ...
  document
    .getElementById("kecamatan_kejadian")
    .addEventListener("change", function () {
      getSelectedValueFromSelect2Container(
        "select2-kecamatan_kejadian-container"
      );
    });
            ...
            fetch(form.action, {
              ...
              .then((html) => {
                const partialContainer =
                  document.getElementById("partialContainer");
