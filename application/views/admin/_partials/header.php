	...
	<div class="navbar-content">
		...
		<ul class="navbar-nav">
				...
				<div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
					<div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
						...
						<div class="text-center">
							<p class="tx-16 fw-bolder"><?= $this->session->userdata('nama_depan')." ".$this->session->userdata('nama_belakang') ?></p>
							<p class="tx-12 text-muted"><?= $this->session->userdata('username') ?></p>
						</div>
					</div>
          <ul class="list-unstyled p-1">
            ...
            <li class="dropdown-item py-2">
              <a href="<?= base_url("login/logout") ?>" class="text-body ms-0">
