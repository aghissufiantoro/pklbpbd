  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form id="addForm" action="<?php echo site_url('admin/lokasi_pos/add') ?>" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <input type="text" readonly style="cursor: not-allowed;" class="form-control" name="lat_lokasi_pos">
                  </div>
                  <div class="col-md-6">
                    <input type="text" readonly style="cursor: not-allowed;" class="form-control" name="lon_lokasi_pos">
                  </div>
                </div>
              </div>
              <div class="mb-3">
                <label class="form-label" for="alamat_lokasi_pos">Alamat</label>
                <input type="text" class="form-control" name="alamat_lokasi_pos" id="alamat_lokasi_pos" autocomplete="off">
              </div>
              <div class="mb-3">
                <label for="ket_lokasi_pos" class="form-label">Keterangan</label>
                <input id="ket_lokasi_pos" class="form-control" name="ket_lokasi_pos" type="text" autocomplete="off">
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
