...
<body>
  ...
  <?php $this->load->view('front/_partials/page/laporan_realisasi_anggaran') ?>
  <?php $this->load->view('front/_partials/page/laporan_operasional') ?>
  <?php $this->load->view('front/_partials/page/neraca') ?>
  <?php $this->load->view('front/_partials/page/data_aset_inventaris') ?>
