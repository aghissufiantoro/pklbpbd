    ...
    public function export() {
        ...
        if (isset($_POST['export'])) {
            ...
            foreach ($db_data_kejadian as $res_data_kejadian) {
                $keca = $res_data_kejadian->kecamatan; // Assuming 'kecamatan' is a property of $res_data_kejadian
                $kelu = $res_data_kejadian->desa; // Assuming 'desa' is a property of $res_data_kejadian
